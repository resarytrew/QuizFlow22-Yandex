                        ...
                        <div className="flex items-start gap-4 p-5 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200/50 rounded-2xl">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-blue-700 leading-relaxed">
                                    Квизы появятся в общественной галерее только после проверки и одобрения администратором. Вы можете в любой момент снять квиз с публикации или изменить его настройки.
                                </p>
                            </div>
                        </div>
